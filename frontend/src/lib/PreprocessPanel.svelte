...
<div style="padding: 0 12px">
  <button
    class="sidebar-btn"
    style="padding:6px 0;width:100%;text-align:left;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#6b7280;display:flex;justify-content:space-between"
    onclick={() => open = !open}
  >
    Preprocessing
    <span>{open ? '▲' : '▼'}</span>
  ...
  <div class="parse-opts" style="gap:10px">
    ...
    <div>
      <div class="checkbox-row" style="margin-bottom:5px">
        ...
        <label for="win-en" style="margin:0;font-size:12px;color:#94a3b8">Window</label>
    ...
    <div>
      <div class="checkbox-row" style="margin-bottom:5px">
        ...
        <label for="hp-en" style="margin:0;font-size:12px;color:#94a3b8">High-pass filter</label>
      </div>
      {#if preproc.hpEnabled}
        <div style="display:flex;align-items:center;gap:6px">
          ...
          <span style="color:#6b7280;font-size:11px">Hz</span>
        </div>
      {/if}
    </div>
    ...
    <div>
      <div class="checkbox-row" style="margin-bottom:5px">
        ...
        <label for="lp-en" style="margin:0;font-size:12px;color:#94a3b8">Low-pass filter</label>
      </div>
    ...
    <div>
      <div class="checkbox-row" style="margin-bottom:5px">
        ...
        <label for="rs-en" style="margin:0;font-size:12px;color:#94a3b8">Resample</label>
      </div>
